...
<head>
 ...
 var codesite_token = "BGjz9lEgfWEd-YND-UEiKfLkP3k:1387726632889";
 
 
 var CS_env = {"projectName": "crypto-arduino-library", "loggedInUserEmail": "alessandro.pasqualini.1105@gmail.com", "projectHomeUrl": "/p/crypto-arduino-library", "profileUrl": "/u/101195020661210559114/", "relativeBaseUrl": "", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/3076573747170053082", "token": "BGjz9lEgfWEd-YND-UEiKfLkP3k:1387726632889", "domainName": null, "assetHostPath": "https://ssl.gstatic.com/codesite/ph"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Fcrypto-arduino-library%2Fsource%2Fbrowse%2Ftrunk%2FCripto.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/crypto-arduino-library/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span>Cripto.h</span>
 ...
 <a href="/p/crypto-arduino-library/source/browse/trunk/Cripto.h?edit=1"
...
><td class="source">#ifndef Cripto_h<br></td></tr
><tr
id=sl_svn2_5

><td class="source">#define Cripto_h<br></td></tr
><tr
id=sl_svn2_6
...
><td class="source">#define	MD5_HA	1<br></td></tr
><tr
id=sl_svn2_8

><td class="source">#define	SHA1_HA	2<br></td></tr
><tr
id=sl_svn2_9

><td class="source">#define	AES_EA	3<br></td></tr
><tr
id=sl_svn2_10
...
><td class="source">// Longitu del hash generado (en bytes)<br></td></tr
><tr
id=sl_svn2_12

><td class="source">#define	HASH_LENGTH	(128/8)<br></td></tr
><tr
id=sl_svn2_13

><td class="source">#define	HASH_IV	0x9e, 0x37, 0x79, 0xb9, 0x9e, 0x37, 0x79, 0xb9, \<br></td></tr
><tr
id=sl_svn2_14

><td class="source">		0x9e, 0x37, 0x79, 0xb9, 0x9e, 0x37, 0x79, 0xb9<br></td></tr
><tr
id=sl_svn2_15
...
><td class="source">// Tamaño del bloque del cifrador XXTEA (en bytes)<br></td></tr
><tr
id=sl_svn2_17

><td class="source">#define	BLOCK_SIZE	(128/8)<br></td></tr
><tr
id=sl_svn2_18

><td class="source">#define	KEY_SIZE	(128/8)<br></td></tr
><tr
id=sl_svn2_19
...
><td class="source">class Cripto<br></td></tr
><tr
id=sl_svn2_23
...
><td class="source">	Cripto();<br></td></tr
><tr
id=sl_svn2_26

><td class="source">	bool setAlgorithm(int algorithm);  // set the cryptographyc (hash, encryption) algorithm to use<br></td></tr
><tr
id=sl_svn2_27

><td class="source">	void setDebugging(bool flag);<br></td></tr
><tr
id=sl_svn2_28

><td class="source">	//void calculateHash(void);<br></td></tr
><tr
id=sl_svn2_29

><td class="source">	void calculateHash(unsigned char *inputText, unsigned int len, unsigned char *hash);<br></td></tr
><tr
id=sl_svn2_30

><td class="source">	void calculateHash2(unsigned char *inputText, unsigned int len, unsigned char *hash);<br></td></tr
><tr
id=sl_svn2_31

><td class="source">	void calculateHMAC(unsigned char *inputText, unsigned int inputTextLength, uint32_t *k, unsigned char *hash);<br></td></tr
><tr
id=sl_svn2_32

><td class="source">	void calculateHMAC2(unsigned char *inputText, unsigned int inputTextLength, uint32_t *k, unsigned char *hash);<br></td></tr
><tr
id=sl_svn2_33
...
><td class="source">	int encrypt(unsigned char *inputText, unsigned int inputTextLength, uint32_t *k);<br></td></tr
><tr
id=sl_svn2_35

><td class="source">	int decrypt(unsigned char *inputText, unsigned int inputTextLength, uint32_t *k);<br></td></tr
><tr
id=sl_svn2_36
...
><td class="source">	uint8_t hash_algorithm;               // index into the channel data for this servo<br></td></tr
><tr
id=sl_svn2_38

><td class="source">	uint8_t encryption_algorithm;                       // minimum is this value times 4 added to MIN_PULSE_WIDTH    <br></td></tr
><tr
id=sl_svn2_39
...
<script type="text/javascript">
 ...
 by doscar
 on Feb 24, 2010
 &nbsp; <a href="/p/crypto-arduino-library/source/diff?spec=svn2&r=2&amp;format=side&amp;path=/trunk/Cripto.h&amp;old_path=/trunk/Cripto.h&amp;old=">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/Cripto.h';
 ...
 <a href="/p/crypto-arduino-library/source/list?path=/trunk/Cripto.h&start=2">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//crypto-arduino-library.googlecode.com/svn/trunk/Cripto.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn2': '/trunk/Cripto.h'}
 codereviews = CR_controller.setup(
 {"projectName": "crypto-arduino-library", "loggedInUserEmail": "alessandro.pasqualini.1105@gmail.com", "projectHomeUrl": "/p/crypto-arduino-library", "profileUrl": "/u/101195020661210559114/", "relativeBaseUrl": "", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/3076573747170053082", "token": "BGjz9lEgfWEd-YND-UEiKfLkP3k:1387726632889", "domainName": null, "assetHostPath": "https://ssl.gstatic.com/codesite/ph"}, '', 'svn2', paths,
